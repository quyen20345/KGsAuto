...
from extractv2.promptv2 import get_extraction_prompt
...
class KGExtractorV2:
    ...
    def extract_from_dir(self, input_dir: str = "data/raw/uet", output_dir: str = "data/extracted_v2"):
