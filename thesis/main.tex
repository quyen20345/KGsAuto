...
% Chapter 4: Trích xuất Knowledge Graph từ dữ liệu văn bản
...
% Chapter 6: Ứng dụng Knowledge Graph trong hệ thống hỏi đáp
\input{content/chapter6}
\clearpage

% Chapter 7: Thực nghiệm và đánh giá
\input{content/chapter7}
\clearpage

% Chapter 8: Kết luận và hướng phát triển
