...
def run_graph_search(pipeline, question: str, top_k: Optional[int], include_evidence: bool) -> dict:
    ...
    budgets = effective_budgets(pipeline.config, "graph_search", top_k)
    return graph_search_response(question, result, include_evidence, budgets)
...
def graph_search_response(
    question: str,
    result: dict,
    include_evidence: bool,
    budgets: dict[str, object],
    mode: str = "graph_search",
) -> dict:
